var auth = ( function () {
    ...
    //document.getElementById('loginform').action = ssoUrl+'sso/login?redirectURI='+myUrl;
    //document.getElementById('logoutbutton').href = ssoUrl+'sso/logout?redirectURI='+myUrl;
